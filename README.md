...
The SportsDataIO SDK for TypeScript provides typed access to the SportsDataIO REST APIs from Node.js and the browser.
...
NFL API - OpenAPI 3.1 Specification, NBA API - OpenAPI 3.1 Specification, MLB API - OpenAPI 3.1 Specification, NHL API - OpenAPI 3.1 Specification, CFB API - OpenAPI 3.1 Specification, CBB API - OpenAPI 3.1 Specification, WNBA API - OpenAPI 3.1 Specification, CWBB API - OpenAPI 3.1 Specification, SOCCER API - OpenAPI 3.1 Specification, GOLF API - OpenAPI 3.1 Specification, NASCAR API - OpenAPI 3.1 Specification, MMA API - OpenAPI 3.1 Specification
...
```ts
import sdk = require("sports-data-io");

const client = new sdk.SportsDataIoClient({
...
This SDK ships a generated **SDK map** — [`sdk-map.md`](sdk-map.md) plus the pages under [`map/operations/`](map/operations/nfl-v3-scores.md) — a deterministic, lookup-oriented table of contents of the TypeScript surface, generated alongside the SDK.
...
| Use | For |
| --- | --- |
| **[`sdk-map.md`](sdk-map.md) + [`map/operations/`](map/operations/nfl-v3-scores.md)** | Traversing the SDK and working out its surface — locating the operation you need (this SDK exposes **741 operations**), its exact signature, which credential it sends, which channel every request field travels on, which error type it rejects with and how to read it, and the file behind any type. This is the index to consume the SDK from, and the one to reach for first. |
