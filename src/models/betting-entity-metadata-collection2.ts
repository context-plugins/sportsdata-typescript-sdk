...
export type BettingEntityMetadataCollection2 = {
...
export const bettingEntityMetadataCollection2Schema: Schema<BettingEntityMetadataCollection2> =
  s.object<BettingEntityMetadataCollection2>({
