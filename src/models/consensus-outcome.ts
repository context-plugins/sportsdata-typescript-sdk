...
import { sportsbook1Schema, type Sportsbook1 } from "./sportsbook1.js";
...
export const consensusOutcomeSchema: Schema<ConsensusOutcome> = s.object<ConsensusOutcome>({
  ...
  sportsBook: s.optional(s.lazy(() => sportsbook1Schema)),
