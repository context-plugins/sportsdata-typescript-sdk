...
export const playerGameRedZoneSchema: Schema<PlayerGameRedZone> = s.object<PlayerGameRedZone>({
  gameKey: s.optionalNullable(s.string()),
  playerId: s.optionalNullable(s.number()),
  seasonType: s.optional(s.number()),
  season: s.optional(s.number()),
  gameDate: s.optionalNullable(s.string()),
  ...
  snapCountsConfirmed: s.optionalNullable(s.boolean()),
