...
export type PlayerTournamentProjection = {
...
export const playerTournamentProjectionSchema: Schema<PlayerTournamentProjection> =
  s.object<PlayerTournamentProjection>({
