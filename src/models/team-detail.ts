...
import { player7Schema, type Player7 } from "./player7.js";
...
export const teamDetailSchema: Schema<TeamDetail> = s.object<TeamDetail>({
  players: s.optional(s.array(s.lazy(() => player7Schema))),
